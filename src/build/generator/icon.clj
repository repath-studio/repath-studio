(ns build.generator.icon
  "Shadow-cljs build hook that watches src/icons for SVG files and generates a
   src/generated/icons.cljs namespace containing all icons."
  (:require
...
(defn generate-source
  ...
  (let [entries (map format-icon-entry icons-map)]
    (str ";; ============================================================\n"
         ...
         ";; Generated by build.generator.icon from src/icons/*.svg\n"
         ";; ============================================================\n"
         "(ns generated.icons)\n"
         "\n"
         "(def defaults\n"
...
(defn output-file-path! []
  (io/file "src" "generated" "icons.cljs"))
